...
import type { StoreSelectorProps, Store } from './StoreSelector.type';
...
const meta: Meta<typeof StoreSelector> = {
  title: 'molecules/StoreSelector',
  component: StoreSelector,
  parameters: {
    layout: 'centered',
    docs: {
      description: {
        component: 'StoreSelector component allows users to select from a list of stores with search functionality and the ability to create new stores.'
      }
    }
  },
  tags: ['autodocs'],
...
export default meta;
type Story = StoryObj<Meta<typeof StoreSelector>>;
