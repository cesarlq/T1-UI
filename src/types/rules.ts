...
export interface InitialStateRulesI {
    ...
    logs: { logs: LogI[], pagination: PaginationI } | null
}
...
export interface RuleI {
    ...
    zones: string[] | { id: string, name: string }[];
    originZones?: string[] | { id: string, name: string }[];
    created_at: string;
    updated_at: string
...
interface AppliedConditions {
    ...
    conditions: Record<string, { applied: boolean, description: string }>
}
